    ...
    <main className="page settings-page">
      ...
      <section className="page-intro">
        ...
        <p className="page-copy">
          Set your default readout, test with demo data, or clear the training
          set.
        </p>
      </section>
      ...
      <section className="content-panel setting-row">
        <div className="setting-info">
          ...
          <div className="setting-desc">
            Switch the app between Celsius and Fahrenheit.
          </div>
        </div>
        <div
      ...
      <section className="content-panel setting-row">
        <div className="setting-info">
          ...
          <div className="setting-desc">
            Switch between the new editorial light theme and a dark mode
            variant.
          </div>
        </div>
        <div className="toggle-group" role="group" aria-label="Appearance">
          <button
            type="button"
            className={`toggle-opt ${theme === 'light' ? 'active' : ''}`}
          ...
          <button
            type="button"
            className={`toggle-opt ${theme === 'dark' ? 'active' : ''}`}
      ...
      <section className="content-panel setting-row">
        <div className="setting-info">
          ...
          <div className="setting-desc">
            Choose the activity that should be preselected when the app opens.
          </div>
        </div>
        <div
          className="toggle-group toggle-group-wide"
          role="group"
          aria-label="Default Activity"
        >
      ...
      <section className="content-panel action-panel">
        ...
        >
          {confirmClear
            ? 'Tap again to permanently delete logs'
            : 'Clear All Logs'}
        </button>
      </section>
